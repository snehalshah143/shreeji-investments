        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Get in touch with our financial experts for personalized advice 
              and consultation. We're here to help you achieve your financial goals.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mb-1">+91 9922244479 (Primary)</p>
                      <p className="text-gray-600 mb-1">+91 9632359042 (Secondary)</p>
                      <p className="text-gray-600">+91 9834101606 (Expert)</p>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <a
                  href="https://wa.me/919922244479?text=Hi! I am interested in your financial advisory services. Please provide me with more information."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-4 px-6 rounded-lg transition-all duration-300 hover:scale-105 shadow-lg flex items-center justify-center space-x-3"
                >
