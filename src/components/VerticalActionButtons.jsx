    ...
    <div className="fixed right-4 top-1/2 transform -translate-y-1/2 z-40 hidden lg:block">
      <div className="flex flex-col space-y-4">
        ...
        <button
          ...
          className="bg-navy-900 hover:bg-navy-800 text-white font-semibold py-4 px-6 rounded-full shadow-lg transition-all duration-300 hover:scale-105 flex items-center space-x-3 group writing-mode-vertical-rl"
          style={{
        ...
        >
          <span className="transform rotate-180">OPEN DEMAT ACCOUNT</span>
          <svg 
            className="w-5 h-5 group-hover:translate-x-1 transition-transform duration-200 transform rotate-90" 
            fill="none" 
            stroke="currentColor" 
            viewBox="0 0 24 24"
          >
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="bg-navy-900 hover:bg-navy-800 text-white font-semibold py-4 px-6 rounded-full shadow-lg transition-all duration-300 hover:scale-105 flex items-center space-x-3 group"
            style={{
              writingMode: 'vertical-rl',
              textOrientation: 'mixed',
              minHeight: '120px',
          ...
          >
            <span className="transform rotate-180">BUY INSURANCE</span>
            <svg 
              className={`w-5 h-5 transition-transform duration-200 transform rotate-90 ${isInsuranceDropdownOpen ? 'rotate-180' : ''}`} 
              fill="none" 
              stroke="currentColor" 
              viewBox="0 0 24 24"
            >
          ...
          {/* Insurance Options Dropdown - Positioned to the left */}
          {isInsuranceDropdownOpen && (
            <div className="absolute top-0 right-full mr-4 w-64 bg-white rounded-lg shadow-xl border border-gray-200 z-50">
              <div className="py-2">
                <button
